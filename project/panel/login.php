        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="login_kontrol.php" method="POST">
              ...
              <div>
                <input type="text" name="kadi" class="form-control" placeholder="Username" required="" />
              </div>
              <div>
                <input type="password" name="sifre" class="form-control" placeholder="Password" required="" />
              </div>
              <div>
                <input type="submit" name="" value="Giriş Yap" class="btn btn-default submit">
              ...
              <div class="separator">
                <p class="change_link">Bir hesabın yok mu?
